...
router.route('/users/:id').patch(_tokenAuthentication["default"], _checkAdmin["default"], _userController["default"].updatehUserRole); // loans route

router.route('/loans').get(_tokenAuthentication["default"], _checkAdmin["default"], _loanController["default"].allLoans).post(_tokenAuthentication["default"], checkIfVerify, _loanValidation["default"].applyLoan, _loanController["default"].apply);
router.route('/loans/:loanId').get(_tokenAuthentication["default"], _loanController["default"].getOneLoan).patch(_tokenAuthentication["default"], _loanController["default"].approvedb);
